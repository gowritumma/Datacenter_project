class DatacentersController < ApplicationController
  ...
  def destroy
    @datacenter.destroy
    respond_to do |format|
      format.html { redirect_to datacenters_url, notice: 'Datacenter was successfully destroyed.' }
  ...
  private
    ...
    def datacenter_params
      params.require(:datacenter).permit(:code, :servers_available, :servers_capacity, :country_id)
    end
end
